...
namespace Tetris_avalonia.Models
{
    internal class TetraminoJ : Tetramino
    {
        private readonly Position[][] tiles = new Position[][]
        {
            ...
            new Position[] { new Position(0, 2), new Position(1, 2), new Position(2, 2), new Position(2, 1) },
            new Position[] { new Position(0, 0), new Position(0, 1), new Position(0, 2), new Position(1, 2) },
